...
if (isset($_POST['submit'])) { // Fetching variables of the form which travels in URL
    $participantId = $_POST['newParticipant'];

    if ($participantId != '') {
        //Insert Query of SQL

        $tournamentParticipantsAddQuery = mysqli_query($db, "insert into TournamentOrganisers(tournament_id, organiser) values ($participantId, $tournamentId)");
